...
export const posterContentLeft = 'rounded-tl-[12rem] sm:rounded-tl-[20rem] lg:rounded-tl-[30rem] border-t-2 border-l-2 ml-20 sm:ml-auto xl:ml-100 3xl:ml-auto xl:pb-[18rem]';
