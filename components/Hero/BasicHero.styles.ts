...
export const root = (paddingType: HeroPaddingType, hasVideo: boolean) => cnb('relative break-words bg-black-70', {
  // No background video
  'pt-[45vw] pb-[15vw] sm:pt-[30vw] sm:pb-[12vw] xl:pt-[25vw] xl:pb-[8vw] 3xl:pt-400 3xl:pb-140': paddingType === 'top' && !hasVideo,
  ...
  'pt-[45vw] sm:pt-[30vw] xl:pt-[25vw] 3xl:pt-400': paddingType === 'top' && hasVideo,
  'pt-[34vw] sm:pt-[24vw] xl:pt-[16vw] 3xl:pt-260': paddingType === 'balance-sm' && hasVideo,
  'pt-[36vw] sm:pt-[26vw] xl:pt-[17vw] 3xl:pt-300': paddingType === 'balance-md' && hasVideo,
  'pt-[40vw] sm:pt-[28vw] xl:pt-[19vw] 3xl:pt-360': paddingType === 'balance-lg' && hasVideo,
...
export const videoButton = (paddingType: HeroPaddingType) => cnb('relative block z-10 ml-auto mr-0', {
  'mt-[15vw] sm:mt-[12vw] xl:mt-[8vw] 3xl:mt-140': paddingType === 'top',
  'mt-[34vw] sm:mt-[24vw] xl:mt-[16vw] 3xl:mt-260': paddingType === 'balance-sm',
  'mt-[36vw] sm:mt-[26vw] xl:mt-[17vw] 3xl:mt-300': paddingType === 'balance-md',
  'mt-[40vw] sm:mt-[28vw] xl:mt-[19vw] 3xl:mt-360': paddingType === 'balance-lg',
});
