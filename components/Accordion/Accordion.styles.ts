...
export const itemHeading = 'relative w-full mb-0 text-18 md:big-paragraph';
export const button = 'group relative w-full text-left pr-40 md:pr-60 pt-16 pb-18 pl-12 md:pl-20';
export const bar = 'absolute top-0 left-0 group-hocus-visible:w-6 group-hocus-visible:md:w-8 scale-y-0 transition-transform group-hocus-visible:scale-y-100 bottom-0 bg-digital-red-light';
