...
export const grid = 'w-full gap-y-50 md:gap-y-65 2xl:gap-y-70 lg:gap-x-[7vw] 3xl:gap-x-300';
export const socialList = 'list-unstyled gap-x-10 *:mb-0 -ml-7';
export const socialIcon = '[&_svg]:w-50 xl:[&_svg]:w-65 text-white hocus:text-digital-red-light transition-colors';
