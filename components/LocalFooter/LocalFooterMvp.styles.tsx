...
export const socialIcon = '[&_svg]:w-50 xl:[&_svg]:w-65 text-white transition-colors';
export const socialInstagram = `${socialIcon} hocus:text-instagram`;
export const socialFacebook = `${socialIcon} hocus:text-facebook`;
export const socialLinkedin = `${socialIcon} hocus:text-linkedin`;
