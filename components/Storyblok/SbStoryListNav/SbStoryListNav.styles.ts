...
// Mobile styles
export const filterButton = 'block w-[28rem] sm:w-[48rem] text-left text-18 sm:text-21 w-fit border-2 border-gc-black-80 text-gc-black-40 rounded-full px-20 py-9 sm:px-30 sm:py-14 mx-auto hocus-visible:bg-gradient-to-r hocus-visible:from-digital-red hocus-visible:to-cardinal-red-dark hocus-visible:border-digital-red-xlight hocus-visible:text-white hocus-visible:underline underline-offset-4 decoration-1 transition-colors';
