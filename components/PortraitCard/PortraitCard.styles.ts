export const root = 'relative overflow-hidden max-w-400 mx-auto md:max-w-none break-words';
...
export const content = 'rs-pt-3 rs-px-2 rs-pb-4 bg-black-true/50 w-full absolute bottom-0 left-0';
