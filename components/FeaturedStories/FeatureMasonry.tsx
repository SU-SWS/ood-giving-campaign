    ...
    <Container {...props} width="full">
      <Grid lg={12} gap="default">
        ...
        >
          ...
          <EmbedMedia
            mediaUrl={audioUrl}
            className="relative z-10 rs-py-6 *:w-4/5 *:mx-auto lg:children:children:aspect-w-2 lg:children:children:aspect-h-1 xl:children:children:aspect-w-4 xl:children:children:aspect-h-1"
          />
        </FlexBox>
        <FlexBox
