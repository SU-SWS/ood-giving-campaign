...
export const image = 'object-cover backface-hidden w-full h-full group-hover:scale-105 group-focus-within:scale-105 transition-transform will-change-transform';
