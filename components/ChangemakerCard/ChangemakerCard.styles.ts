export const root = 'group relative [perspective:100rem] w-full max-w-400 mx-auto md:max-w-none break-words transition-transform focus-visible:outline-none';
...
export const heading = 'mb-02em group-hover:opacity-50 transition-opacity delay-100';
export const content = 'group-hover:opacity-50 transition-opacity delay-100 rs-pt-3 rs-px-2 rs-pb-8 absolute w-full bottom-0 left-0';
export const cta = '';
