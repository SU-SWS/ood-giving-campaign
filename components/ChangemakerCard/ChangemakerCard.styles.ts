...
export const cardContent = (isHorizontal: boolean) => cnb('absolute size-full top-0 left-0  aria-hidden:opacity-0 opacity-100 backdrop-blur-sm transition-opacity duration-500 bg-gradient-to-b from-gc-black/60 to-gc-black/90 gc-changemaker *:*:*:!mb-1em', {
  'px-20 py-30 3xl:py-48 3xl:px-36' : !isHorizontal,
