...
export const cardBack = 'group/back backface-hidden absolute w-full h-full top-0 left-0 px-20 py-30 3xl:py-48 3xl:px-36 bg-gradient-to-b from-gc-black/70 to-gc-black/90 [transform:rotateY(180deg)] gc-changemaker';
