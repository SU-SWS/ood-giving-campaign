export const root = 'group relative [perspective:100rem] w-full max-w-[25rem] sm:max-w-300 lg:max-w-[35rem] mx-auto break-words transition-transform focus-visible:outline-none';
...
export const button = 'group/button absolute w-full h-full top-0 left-0';
export const flipIcon = 'absolute bottom-50 right-36 text-white w-65 h-65 border-2 border-white rounded-full p-16 group-hocus/button:border-dashed group-hocus/button:rotate-45';
