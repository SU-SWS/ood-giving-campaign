...
export const heading = 'su-absolute su-bottom-0 su-w-full su-bg-black-true/60 su-text-white su-rs-p-1 su-mb-0 group-hover:su-bg-black-true/70 su-border-y-4 su-border-transparent group-hover:su-border-white su-transition-all su-text-shadow-sm group-hover:su-rs-py-2 group-focus-within:su-rs-py-2';
