...
export const HomepageHero = () => {
  ...
  const darkMesh5 = 'radial-gradient(at 66% 1%, rgb(224 235 3 / 87%) 0px, rgba(236, 243, 98, 20%) 30%, rgba(236, 243, 98, 0) 50%), radial-gradient(at 18% 10%, #E31C79 0px, rgba(247, 24, 161, 0) 50%), radial-gradient(at 54% 50%, rgb(238, 65, 43) 0px, rgba(238, 65, 43, 0) 50%), radial-gradient(at 50% 12%, rgb(248, 83, 22) 0px, rgba(248, 83, 22, 0) 50%), radial-gradient(at 22% 15%, rgb(247, 183, 8) 0px, rgba(247, 183, 8, 0) 50%)';
