...
export const heading = 'su-rs-mt-1 su-rs-mb-neg1 su-underline su-decoration-transparent group-focu-within:su-decoration-digital-red-light group-hover:su-decoration-digital-red-light su-underline-offset-4 su-transition-colors';
